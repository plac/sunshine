...
public class ForecastFragment extends Fragment {
    ...
    private void UpdateForecasts(View view, List<String> listContent) {
        adapter = new ArrayAdapter<String>(getActivity(), R.layout.list_item_forecast, R.id.list_item_forecast_textview, listContent);
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                ...
                // to parse it.
                forecasts = new String[] { "Problema na conexão." };
